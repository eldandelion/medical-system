    ...
    <div className="rounded-xl border border-[var(--md-sys-color-outline-variant)] border-opacity-50 bg-transparent p-6 flex flex-col gap-4 relative">
      ...
      <div>
        ...
        <p className="text-[14px] text-[var(--md-sys-color-on-surface-variant)] mt-1">
          {type} • 已完成 {completionPercentage}% • {duration}
        </p>
      </div>
      ...
      <div className="flex justify-end mt-2">
        <button
          onClick={onAction}
          className="h-[40px] px-6 bg-[var(--md-sys-color-primary)] text-[var(--md-sys-color-on-primary)] rounded-full text-sm font-medium hover:opacity-90 transition shadow-sm outline-none cursor-pointer"
        >
          {actionLabel}
        </button>
      </div>
